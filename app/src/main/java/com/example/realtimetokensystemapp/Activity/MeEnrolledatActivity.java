...
import com.example.realtimetokensystemapp.Adapter.MeEnrolledAdpter;
...
import static com.example.realtimetokensystemapp.Constant.ConstantUrls.enrolledhosts;
import static com.example.realtimetokensystemapp.Constant.ConstantUrls.myhosts;

public class MeEnrolledatActivity extends AppCompatActivity {
//
    ...
    MeEnrolledAdpter meEnrolledAdpter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_enrolledat_list);
        toolbar=findViewById(R.id.toolbar);

        hostListModelArrayList = new ArrayList<>();
        recyclerhostlist = findViewById(R.id.recyclerhostlist);
        LinearLayoutManager layoutManager = new LinearLayoutManager(MeEnrolledatActivity.this);
    ...
    public void enrolledmeatlistapi() {
        kProgressHUD.show();
        hostListModelArrayList.clear();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, enrolledhosts
                , new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                Log.e("TAG", "enrolledmeatlist: " + response);
                try {
                    ...
                    meEnrolledAdpter = new MeEnrolledAdpter(MeEnrolledatActivity.this, hostListModelArrayList,meEnrolledAdpter);
                    recyclerhostlist.setAdapter(meEnrolledAdpter);
                    meEnrolledAdpter.notifyDataSetChanged();
                    ...
                    e.printStackTrace();
                    Toast.makeText(MeEnrolledatActivity.this, "" + e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(MeEnrolledatActivity.this, "try again after some time", Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
            ...
            public Map<String, String> getHeaders() throws AuthFailureError {
                ...
                hashMap.put("x-access-token", Sharedpref.getAccessToken(MeEnrolledatActivity.this));
...
//                Log.e("TAG", "bytedata: " + ret.getBytes());
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(MeEnrolledatActivity.this);
...
//                RemoveTop(tvHostId.getText().toString());
    ...
    public void dialog() {
        dialog1 = new Dialog(MeEnrolledatActivity.this);
...
//                        startActivity(new Intent(getApplicationContext(), Hostlistactivity.class));
                        dialog1.cancel();
                        Toast.makeText(MeEnrolledatActivity.this, "HostCreated Successfully!", Toast.LENGTH_SHORT).show();
//                        myhosts();
                    } else {
                        kProgressHUD.dismiss();
                        dialog1.cancel();
                        Toast.makeText(MeEnrolledatActivity.this, "" + jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                    kProgressHUD.dismiss();
                    dialog1.cancel();
            ...
            public void onErrorResponse(VolleyError error) {
                if (error instanceof AuthFailureError) {
                    Toast.makeText(MeEnrolledatActivity.this, "" + error, Toast.LENGTH_SHORT).show();
...
//                hashMap.put("Content-Type", "application/json; charset=utf-8");
                ...
                Log.e("TAG", "Token:-" + Sharedpref.getAccessToken(MeEnrolledatActivity.this));
                return hashMap;
            }
