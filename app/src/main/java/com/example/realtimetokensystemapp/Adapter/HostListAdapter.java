...
public class HostListAdapter extends RecyclerView.Adapter<HostListAdapter.ViewHolder> {
    ...
    public HostListAdapter(Context context, ArrayList<HostListModel> hostListModelArrayList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.hostlist_adapter, viewGroup, false);
        ...
        public void bind(final HostListModel model, final int position) {
            ...
            btnNext2.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent i = new Intent(context, MyHostsJoins.class);
                    i.putExtra("hostid", model.getHostID());
                    Sharedpref.setHostIdd(context,model.getHostID());
                    context.startActivity(i);
